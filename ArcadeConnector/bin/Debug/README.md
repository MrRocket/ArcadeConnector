...
- **Hunspell (WeCantSpell.Hunspell)** — spell-checking library  
  - Source: [WeCantSpell.Hunspell GitHub](https://github.com/WeCantSpell/Hunspell)  
  - [Hunspell (MIT)](docs/licenses/LICENSE_Hunspell.txt)
